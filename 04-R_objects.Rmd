...
It is probably not immediately obvious how useful __logicals__ are but you'll see how they are later in the course.
...
A __matrix__ only contains 1 __class__ (homogeneous). A __data frame__ can contain multiple classes (heterogeneous), but each column can only contain one __class__. 
