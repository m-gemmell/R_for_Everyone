...
download_link(
  ...
  button_label = "Download Liverpool beaches csv file",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = TRUE
...
library(downloadthis)
download_link(
  link="https://m-gemmell.github.io/R_for_everyone/downloads/UK_retail.txt",
  button_label = "Download UK_retail.txt",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = TRUE
...
library(downloadthis)
download_link(
  link="https://m-gemmell.github.io/R_for_everyone/downloads/tea_consumption.csv",
  button_label = "Download tea_consumption.csv",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = TRUE
...
library(downloadthis)
download_link(
  link="https://m-gemmell.github.io/R_for_everyone/downloads/english_speaking_population_of_countries.txt",
  button_label = "Download english_speaking_population_of_countries.txt",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = TRUE
...
library(downloadthis)
download_link(
  link="https://m-gemmell.github.io/R_for_everyone/downloads/world_happiness_report_2016.csv",
  button_label = "Download world_happiness_report_2016.csv",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = TRUE
