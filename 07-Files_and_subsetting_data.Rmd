...
To practice subsetting __data frames__ with square brackets we will __read__ in a new file called - __Census_2011_L_postcodes_counts.csv__]. This contains UK 2011 census information on total residents for postcodes that start with the letter L. 
